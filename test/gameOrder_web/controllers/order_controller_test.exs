defmodule GameOrderWeb.OrderControllerTest do
  use GameOrderWeb.ConnCase
  ...
  @invalid_attrs %{buyer_id: nil, game_id: nil, "no-schema": nil, order_price: nil, receiver_id: nil, status: nil}
